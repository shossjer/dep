...
function(_get_dep_config_type outvar config)
	...
	elseif("${config}" STREQUAL "${_debug}")
		...
		message(ERROR "Unexpected config")
	endif()
endfunction()
...
function(dep_package name target)
	...
	foreach(_config IN ITEMS ${_configs})
		...
		endforeach()
		if(_file_type)
			message(ERROR "Expected one more file after ${_file_type}")
		endif()
		...
		if(_parsed_LIBS)
			...
			endforeach()
			if(_lib_type)
				message(ERROR "Expected one more lib after ${_lib_type}")
			endif()
